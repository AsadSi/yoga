          ...
          <div className="lg:col-span-7 space-y-12">
            ...
            <div className="grid grid-cols-3 gap-8 pt-8">
              <div className="text-center">
                <div className="text-5xl font-extralight text-brown mb-4">+5</div>
                <div className="text-sm text-brown-muted font-light">Years Teaching</div>
              </div>
              <div className="text-center">
                <div className="text-5xl font-extralight text-brown mb-4">500+</div>
                <div className="text-sm text-brown-muted font-light">Hours Certified</div>
              </div>
              <div className="text-center">
                <div className="text-5xl font-extralight text-brown mb-4">All</div>
                <div className="text-sm text-brown-muted font-light">Levels Welcome</div>
              </div>
            </div>
          </div>
