...
export default function Flexibility() {
  return (
    <section id="flexibility" className="relative overflow-hidden py-32 sm:py-40 section-brown brown-overlay">
      ...
      <div className="relative mx-auto max-w-[1600px] px-4 sm:px-6 lg:px-8 z-10">
        <div className="grid lg:grid-cols-12 gap-20 items-start mb-32">
          <div className="lg:col-span-5">
            <h2 className="text-6xl sm:text-7xl lg:text-8xl font-extralight text-brown mb-12">Flexibility Training</h2>
          ...
          <div className="lg:col-span-7 space-y-16">
            <div>
              <h3 className="text-4xl font-light text-brown mb-6">Flexibility Classes</h3>
